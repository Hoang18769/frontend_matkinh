    ...
    {productShop.map((item, index) => (
        ...
        <div className="flex items-center justify-between font-titleFont">
          ...
          {item.price_product===item.sellprice_product?
            <p className="text-[#767676] text-[14px]">{item.sellprice_product}VND</p>
            :
            <div></div><p className="text-[#767676] text-[14px]">{item.sellprice_product}VND</p>
            <p class=" text-gray-500 line-through dark:text-gray-500">{item.price_product} VND</p>
          }
