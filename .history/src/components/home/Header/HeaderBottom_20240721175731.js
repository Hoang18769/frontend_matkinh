...
else
{
    AuthButtons = (
        <li className="nav-item">
            <button type="button" onClick={handleLogout()} class="bg-transparent text-gray-800  p-2 rounded border border-gray-300 mr-4 hover:bg-gray-100 hover:text-gray-700">Logout</button>
        </li>
    );
}
  const ref = useRef();
