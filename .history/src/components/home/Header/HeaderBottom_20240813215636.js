...
else
{
    AuthButtons = (
        <div className="nav-item">
            <button  onClick={logout} class="bg-transparent text-gray-800  p-2 rounded border border-gray-300 mr-4 hover:bg-gray-400 hover:text-gray-700">Đăng xuất</button>
        </div>
    );
}
  const ref = useRef();
