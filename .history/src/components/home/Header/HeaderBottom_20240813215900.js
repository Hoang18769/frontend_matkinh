    ...
    AuthButtons = (
      ...
      <div class="order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4" id="nav-content">
            <div class="auth flex items-center w-full md:w-full">
                <Link class="bg-transparent text-gray-800  p-2 rounded border border-gray-300 mr-4 hover:bg-gray-400 hover:text-gray-700" to="/signin">Đăng nhập</Link>
          
                <Link class="bg-indigo-700 text-white  p-2 rounded  hover:bg-indigo-500 hover:text-gray-100" to="/signup">Đăng ký</Link>
                </div>
        </div>
    );
}
