      ...
      <div className="max-w-container mx-auto grid grid-cols-1 md:grid-cols-2  xl:grid-cols-6 px-4 gap-10">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2">
           <Link to="new_Arrivals"> <li className="font-titleFont text-base text-lightText hover:text-black hover:underline decoration-[1px] decoration-gray-500 underline-offset-2 cursor-pointer duration-300">
              Sản phẩm mới
            </li></Link>
        ...
        <div className="col-span-2 flex flex-col items-center w-full px-4">
          <FooterListTitle
            title="Theo dõi bản tin của chúng tôi."
          />
