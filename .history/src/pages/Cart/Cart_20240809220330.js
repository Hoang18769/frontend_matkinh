      ...
      {products?.length > 0 ? (
        ...
        >
          ...
          <div className="max-w-[500px] p-4 py-8 bg-white flex gap-4 flex-col items-center rounded-md shadow-lg">
            ...
            <Link to="/shop">
              <button className="bg-primeColor rounded-md cursor-pointer hover:bg-indigo active:bg-gray-900 px-8 py-2 font-titleFont font-semibold text-lg text-gray-200 hover:text-white duration-300">
                Tiếp tục mua sắm
              </button>
            </Link>
          </div>
