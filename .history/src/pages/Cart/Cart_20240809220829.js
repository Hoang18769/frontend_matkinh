          ...
          <div className="max-w-7xl gap-4 flex justify-end mt-4">
            <div className="w-96 flex flex-col gap-4">
              ...
              <div onClick={handleCart} className="flex justify-end">
                ...
                <button class="relative group overflow-hidden px-6 h-12 rounded-lg flex space-x-2 items-center bg-gradient-to-r from-indigo-500 to-indigo-500 hover:to-purple-600">
