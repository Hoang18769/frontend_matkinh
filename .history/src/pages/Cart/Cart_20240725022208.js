...
const Cart = () => {
  ...
  return (
    <div className="max-w-container mx-auto px-4">
      ...
      {products?.length > 0 ? (
        <div className="pb-20">
          <div className="xl:w-3/5 w-full h-20 bg-[#F5F7F7] text-primeColor hidden lgl:grid grid-cols-5 place-content-center px-6 text-lg font-titleFont font-semibold">
          ...
          <div className="xl:2/5 w-full max-w-7xl gap-4 flex justify-end mt-4">
