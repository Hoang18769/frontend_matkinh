        ...
        <div className=" gap-4 w-2/5">
          <div className="w-96 flex flex-col gap-3">
            <h1 className="text-2xl font-semibold text-right">Đơn hàng</h1>
              ...
              {products.map((item) => (
                <div class=" text-gray-800 font-light border-gray-200">
            ...
            <div className="bg-white shadow-md rounded px-4 pt-4 pb-8 mb-4 my-2 ">
              <p className="text-md appearance-none flex items-center justify-between w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3">
                Subtotal
