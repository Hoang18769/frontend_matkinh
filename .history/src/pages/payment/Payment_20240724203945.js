            ...
            <div className="w-96 flex flex-col gap-5">
              ...
              <div className="bg-white shadow-md rounded px-4 pt-6 pb-8 mb-4 flex flex-col my-2">
               ...
               <label class="text-gray-600 font-semibold text-sm mb-2 ml-1">
                  ...
                  <div className="flex-grown items-center justify-between">
                  {voucher.map((item) => (
                       <div class=" text-gray-800 border border-gray-300 bg-gray-100 font-mono text-sm py-2 px-3  rounded-lg">
                       <div class=" gap-1">
                         <span>{item.code}</span>
                       </div>
