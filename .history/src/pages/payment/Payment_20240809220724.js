      ...
      <div className="flex">
        ...
        <div className=" gap-4 w-2/5">
          <div className="w-96 gap-3">
            ...
            <button
                onClick={submitOrder}
                class="relative group overflow-hidden px-10 h-12 rounded-lg flex space-x-2 items-center bg-gradient-to-r from-indigo-500 to-indigo-500 hover:to-purple-600"
              >
