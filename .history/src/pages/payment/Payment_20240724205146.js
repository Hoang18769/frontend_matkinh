      ...
      <div className=" gap-4 w-2/5">
        ...
        <div class="w-full flex items-center">
            ...
            <div class="flex-grow pl-3">
                <h6 class="font-semibold uppercase text-gray-600">{item.name_product}</h6>
                <p class="text-gray-400">{item.quantity}</p>
            </div>
            <div>
                <span class="font-semibold text-black text-xl">{item.price_product}VND</span>
            </div>
        </div>
    </div>                ))
              ...
              <div className="bg-white shadow-md rounded px-4 pt-6 pb-8 mb-4 flex flex-col my-2">
              ...
              {voucher.map((item) => (
                       <div class="flex items-center justify-between text-gray-800 border border-gray-300 bg-gray-100 font-mono text-sm py-2 px-3  w-[160px] rounded-lg">
                       <div class="flex gap-1">
                         <span>{item.code}</span>
                       </div>
                       <span onClick={() => {navigator.clipboard.writeText(this.state.textToCopy)}} class="flex text-white cursor-pointer w-5 h-5 hover:text-gray-400 duration-200">
