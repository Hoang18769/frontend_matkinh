        ...
        <div className=" gap-4 w-2/5">
          <div className="w-96 gap-3">
            ...
            <div className="bg-white shadow-md rounded px-4 pt-4 pb-8 mb-4 my-2 ">
              ...
              {voucher.map((item) => (
                <div class=" text-gray-800 border border-gray-300 bg-gray-100 font-mono text-sm py-2 px-3 mx-2 my-2  rounded-lg">
                  <div class=" gap-1">
                    <span>{item.code}</span>
                  </div>
                  <span
                    ...
                    class=" text-white cursor-pointer w-4 h-4 hover:text-gray-400 duration-200"
                  >
                    <svg
