                ...
                <div className="w-fit">
                  ...
                  >
                    <MenuItem className="w-fit bg-white">
                      <div className=" ">
                        <>
                          <div className="flex rounded-md justify-between px- items-center text-center bg-[#F5F5F3]">
                            <div className="invisible w-12 ">a</div>
                            <div className="w-48 border ">Tên sản phẩm</div>
                          ...
                          {item.order_details?.map((item) => (
                            <div
                              id={item.id_order}
                              className="w-min flex justify-between rounded-md items-center text-center border-b px- py-2	"
                            >
                              <img
