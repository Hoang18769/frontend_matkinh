          ...
          <>
            ...
            <div className="w-full ">
              <Menu>
                ...
                <MenuItems
                  anchor="bottom"
                  className=" px-8 py-4 block center relative w-[100%] bg-slate-200 rounded-lg justify-between"
                >
                  {item.order_details?.map((item) => (
                    <MenuItem className="block center relative w-[150%] bg-white rounded-lg">
