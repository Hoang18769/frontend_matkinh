        ...
        <ul>
          {ProfileList.map(({ id, title, link }) => (
            ...
            <label for="name"> Tên khách hàng: </label>
             <input id="name"  className=" font-mono text-xl px-8 tracking-wide" value={customer.name_customer}/><br/>
                 <label for="phone">Số điện thoại: </label>
                  <input id="phone"  className="font-mono text-xl px-8 tracking-wide"value={customer.phone_customer}/><br/>
                <label for="email">Email đăng ký: </label>
                 <input id="email"  className="font-mono text-xl px-8 tracking-wide" value={customer.email_customer}/><br/>
                <label for="address">Địa chỉ: </label>
                 <input id="address"  className="font-mono text-xl px-8 tracking-wide" value={customer.address_customer}/><br/>
