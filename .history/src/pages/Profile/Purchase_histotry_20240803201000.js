                      ...
                      <div className=" ">
                        <>
                          <div className="flex rounded-md  items-center text-center bg-[#F5F5F3]">
                            ...
                            <div className="w-44 border ">Tên sản phẩm</div>
                          ...
                          {item.order_details?.map((item) => (
                            ...
                            >
                              <img
                                ...
                                alt="productImage"
                              />
                              <div className="align-center px-2 w-56 border">
                                {item.product.name_product}
                              </div>
                              <div className="px-2 w-44 border">
                                {item.colors?.map((item) => item.desc_color)}
                              </div>
                              <div className="px-2 w-44 border">
                                {item.sizes?.map((item) => item.desc_size)}
                              </div>
                              <div className="px-2 w-44 border">{item.quantity}</div>
                              <div className="px-2 w-44 border">{item.totalprice}</div>
                            </div>
                          ))}
                        </>
                      </div>
