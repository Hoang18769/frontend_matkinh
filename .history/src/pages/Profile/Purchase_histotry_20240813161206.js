    ...
    <div className="w-full lg:flex sm:flex-row px-8 sm:px-0 py-8 ">
      ...
      <div className="w-4/5 sm:w-full items-center px-4 sm:px-0">
        <div className="w-full flex px-8 sm:px-0 py-4 font-bold text-lg bg-[#F5F5F3] rounded-md">
          {list.map((item) => (
            <label className="w-52 sm:ư sm:w-20 py-4  text-center">{item}</label>
          ))}
          <label className="invisible  w-52 sm:ư sm:w-20 py-4 ">hidden</label>
        </div>
        <div className=" ">
                  ...
                  <div className="w-full flex justify-between ">
                    ...
                    >
                      <div className="flex py-4 rounded-md text-base items-center text-center hover:underline underline-offset-[4px] ">
                        <div className="w-52 sm:ư sm:w-20 px-4 py-2 ">{item.id_order}</div>
                        <div className="w-52 sm:ư sm:w-20 px-4 py-2 ">{item.date_order}</div>
                        <div className="w-52 sm:ư sm:w-20 px-4 py-2 ">
