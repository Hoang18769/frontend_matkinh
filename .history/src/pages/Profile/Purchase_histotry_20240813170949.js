                  ...
                  <div className="w-full flex justify-between ">
                    ...
                    >
                      <div className="flex py-4 rounded-md text-base items-center text-center hover:underline underline-offset-[4px] ">
                        <div className="lg:w-52 md:w-44 md:px sm:w-20 lg:px-4 sm:px-0 py-2 ">{item.id_order}</div>
                        <div className="lg:w-52 md:w-44 md:px sm:w-20 lg:px-4 sm:px-0 py-2 ">{item.date_order}</div>
                        <div className="lg:w-52 md:w-44 md:px sm:w-20 lg:px-4 sm:px-0 py-2 ">
