                  ...
                  <div className="w-full flex justify-between ">
                    ...
                    >
                      <div className="flex py-4 rounded-md text-base items-center text-center hover:underline underline-offset-[4px] ">
                        <div className="w-52 sm:w-20 sm:w-20 px-4 py-2 ">{item.id_order}</div>
                        <div className="w-52 sm:w-20 sm:w-20 px-4 py-2 ">{item.date_order}</div>
                        <div className="w-52 sm:w-20 sm:w-20 px-4 py-2 ">
