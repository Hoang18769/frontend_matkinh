...
const Purchase_history = () => {
  ...
  return (
    <div className="w-full lg:flex sm:flex-row px-8 py-8 gap-5">
      <Profile/>

      <div className="w-4/5 sm:w-full items-center px-4">
        <div className="w-full flex px-8 py-4 font-bold text-lg bg-[#F5F5F3] rounded-md">
          {list.map((item) => (
              ...
              <div>
                <div className=" items-center flex justify-between">
                  ...
                  item.order_details.length === item.feedback.length ? (
                    ...
                    item.order_details.length !== item.feedback.length ? (
                    <>
                      <div class="px-4 sm: py-3 whitespace-no-wrap text-right text-sm ">
                        <button
