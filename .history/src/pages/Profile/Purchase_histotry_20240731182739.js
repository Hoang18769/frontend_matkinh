        ...
        {history.map((item) => (
          <>
            ...
            <div className="flex px-8 py-4 border justify-between">
              ...
              <MenuButton onClick={handleDetail} className=" px-4 py-2">Xem chi tiết </MenuButton>
            
            </div>
      //<MenuButton className="w-100%">Chi Tiết </MenuButton>
        ...
        <div className="flex-1 ">
              <>
                  ...
                  {item.order_details?.map((item) => (
                      <div id={item.id_order}  style={{display: show ? 'flex' : 'none'}} className="   justify-between border-b px-4 py-2	">
                        <img
                          className="w-12 h-12"
