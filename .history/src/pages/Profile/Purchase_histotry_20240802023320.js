      ...
      <div className="w-1/5 ">
        <ul>
          {ProfileList.map(({ id, title, link }) => (
            ...
            >
              <li className=" py-5 font-normal hover:font-bold text-center px-4 text-base text-[#767676] hover:underline underline-offset-[4px]  hover:text-[#262626] md:border-r-[2px] border-r-gray-300 hoverEffect last:border-r-0">
                {title} 
              </li>
            </NavLink>
          ))}
