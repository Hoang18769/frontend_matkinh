        ...
        <ul>
          {ProfileList.map(({ id, title, link }) => (
            ...
            <label for="name"> Tên khách hàng: </label>
             <input id="name" className=" font-mono text-xl px-8 tracking-wide" defaultValue={customer.name_customer}/><br/>
                ...
                <input id="date"  className="font-mono text-xl px-8 tracking-wide" defaultValue={customer.created_at}/><br/>
