  ...
  return (
    <div className="w-full flex px-8 py-8 gap-5">
      <div className="w-1/5 ">
        <ul>
          {ProfileList.map(({ id, title, link }) => (
            ...
            >
              <li className=" py-5 font-bold hover:font-bold text-center px-4 text-base text-[#767676] hover:underline underline-offset-[4px] decoration-[1px] hover:text-[#262626] md:border-r-[2px] border-r-gray-300 hoverEffect ">
                {title} +{total}
              </li>
            </NavLink>
          ))}
      ...
      <div className="w-4/5 items-center px-8">
        <div className="flex px-8 py-4 font-bold text-2xl bg-[#F5F5F3] rounded-md">
          {list.map((item) => (
