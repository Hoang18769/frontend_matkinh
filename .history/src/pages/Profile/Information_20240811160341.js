...
const Information = () => {
  ...
  let handleEditable = () => {
    ...
    if (!edit) {
      ...
      document.getElementById("email").disable
    ...
    <div className="w-full flex px-8 py-8 gap-5">
      ...
      {/* <div class="flex w-full h-screen items-center justify-center  bg-gray-100 px-4 sm:flex-row sm:space-x-6 sm:space-y-0">
        ...
        <form>
          ...
          <input
            id="phone"
            class="disabled:opacity-75 editfield appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-4 px-4 mb-3"
            defaultValue={customer.phone_customer}
            readOnly="true"
          />
