...
const Purchase_history = () => {
  ...
  const fetchData = async () => {
    ...
    //  total=history.reduce((a,b)=> {return a+parseInt(b.total_order)})
      history.map((item)=>(
        console.log(typeof parseInt(item.total_order))
      ))
            ...
            <div className=" rounded-md w-full border-b  px-8 items-center ">
              <div>
               <div className=" items-center flex justify-between">
                ...
                <div onClick={()=>handleDetail(item.id_order)} className="w-full">
                  ...
                  {(item.status_order === 4 && item.order_details.length===item.feedback.length)?
                  ...
                  <td class="px-4 py-3 whitespace-no-wrap text-right text-sm ">
                        <button
                          ...
                          class="h-10 w-28 border-blue-500 border text-blue-500 rounded-md transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none"
                        >
                          Đánh giá
                        </button>
                      </td>
                ...
                <div className="w-full ">
                    ...
                    <div className="w-full bg-white">
                      <div key={item.id_order} id={item.id_order} className="hidden">
                        <>
