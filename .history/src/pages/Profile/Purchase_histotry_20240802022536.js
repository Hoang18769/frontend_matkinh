...
<div className="">
{history.map((item) => (
          <div className=" rounded-md border border-b  py-4 text-center">8 items-center" >
            <Menu>
                  <MenuButton className="w-full items-center" >
                  <div className="flex py-4 border-b rounded-md justify-between items-center text-center">
