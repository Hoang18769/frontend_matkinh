            ...
            <div className=" rounded-md w-full border-b  px-8 items-center ">
              <Menu>
                ...
                <div className="w-fit">
                  <MenuItems
                    anchor="bottom"
                    className="z-10  w-fit px-16 flex-1 w-4/5 mr-20 "
                  >
                    <MenuItem className="block bg-white">
                      <div className=" ">
                        <>
                          <div className="flex rounded-md  items-center text-center bg-[#F5F5F3]">
                            <div className="invisible w-48 items-center">a</div>
                            <div className="w-48 ">Tên sản phẩm</div>
                            <div className="w-48 ">Màu</div>
                            <div className="w-48 ">Kích cỡ</div>
                            <div className="w-48 ">Số lượng</div>
                            <div className="w-48 ">Giá</div>
                          </div>
                          ...
                          {item.order_details?.map((item) => (
                            ...
                            >
                              ...
                              <div className="px-2 w-48">{item.quantity}</div>
                              <div className="px-2 w-48">{item.totalprice}</div>
                            </div>
                          ))}
                        </>
                      </div>
