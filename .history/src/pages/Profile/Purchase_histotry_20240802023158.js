      ...
      <div className="w-1/5 ">
        <ul>
          {ProfileList.map(({ id, title, link }) => (
            ...
            >
              <li className=" py-5  rounded-lg font-normal hover:font-bold justify-center items-center px-12 text-base text-[#767676] hover:underline underline-offset-[4px] decoration-[1px] hover:text-[#262626] md:border-r-[2px] border-r-gray-300 hoverEffect last:border-r-0">
                {title} 
              </li>
            </NavLink>
          ))}
