                  ...
                  <div className="w-full bg-white">
                    ...
                    >
                      ...
                      <p className="w-1/2 font-medium appearance-none flex items-center justify-between w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 mx-4 px-2 mb-3">
                        ...
                        <p className="w-1/2 font-medium appearance-none flex items-center justify-between w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 mx-4 mb-3">
                          Số điện thoại
