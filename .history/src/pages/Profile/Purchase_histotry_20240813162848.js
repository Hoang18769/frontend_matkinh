                    ...
                    <>
                      <div class="px-4 sm:px-0 py-3 whitespace-no-wrap text-right text-sm ">
                        <button
                          ...
                          class="h-10 lg:-28  sm:w-20 border-indigo-500 border text-indigo-500 rounded-md transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none"
                        >
                          Đánh giá
                        </button>
                      </div>
