            ...
            <div className=" rounded-md w-full border-b lg:px-8 sm:px-0 items-center ">
                ...
                <div className="w-full ">
                  <div className="w-full bg-white">
                    ...
                    >
                      <>
                      <div className="bg-white shadow-md rounded px-2 pt-4 pb-8 mb-4 my-2 ">
                      ...
                      <p className="w-2/5 font-medium appearance-none flex items-center w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 mx-4 px-2 mb-3">
                        ...
                        <p className="w-1/2 font-medium appearance-none flex items-center w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 mx-4 px-2 mb-3">
                          Số điện thoại
