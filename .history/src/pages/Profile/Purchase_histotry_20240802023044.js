    ...
    <div className="w-full flex px-8 py-8 gap-5">
      <div className="w-1/5 ">
        <ul>
          {ProfileList.map(({ id, title, link }) => (
            ...
            >
              <li className="px-3 py-5 border rounded-lg font-normal hover:font-bold justify-center items-center px-12 text-base text-[#767676] hover:underline underline-offset-[4px] decoration-[1px] hover:text-[#262626] md:border-r-[2px] border-r-gray-300 hoverEffect last:border-r-0">
                {title} 
              </li>
            </NavLink>
          ))}
      ...
      <div className="w-4/5 items-center px-8">
        <div className="flex px-8 py-4  justify-between bg-[#F5F5F3] rounded-md">
          {list.map((item) => (
            <label className="w-56 py-4 text-center">{item}</label>
          ))}
        </div>
<div className="">
{history.map((item) => (
          <div className=" rounded-md  border-b  px-8 items-center" >
            <Menu>
                  ...
                  <div className="flex py-4 rounded-md justify-between items-center text-center">
