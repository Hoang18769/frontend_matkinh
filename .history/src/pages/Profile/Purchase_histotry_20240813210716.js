                ...
                <div className="w-full ">
                  <div className="w-full bg-white">
                    ...
                    >
                      ...
                      <p className="w-4/10 font-medium appearance-none flex items-center w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 mx-4 px-2 mb-3">
                          Tên người nhận:
