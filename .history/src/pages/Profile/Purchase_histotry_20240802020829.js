  ...
  return (
    <div className="w-full flex px-8 py-8 gap-5">
      ...
      <div className="w-4/5 items-center px-8">
        <div className="flex px-4 py-4  justify-between bg-[#F5F5F3] rounded-md">
          {list.map((item) => (
            <label className="w-56 border px-4 py-4 text-center">{item}</label>
          ))}
        </div>
        ...
        {history.map((item) => (
          <div className=" rounded-md" >
            <Menu>
                  ...
                  <MenuButton className="w-full px-8" >
                  <div className="flex  py-4 border-b rounded-md justify-between text-center">
                <div className="w-56 px-4 py-2 border">{item.id_order}</div>
                <div className="w-56 px-4 py-2 border">{item.date_order}</div>
                <div className="w-56 px-4 py-2 border">{item.total_order}</div>
                {
                  status_order_List.map((items)=>(
                    (items.id===item.status_order?<>
                      <div className="w-56 px-4 py-2 border">{items.desc} </div>
                    </>:null)
                  ))
                }
                <div>
                ...
                <MenuItem className="block bg-white">
                  <div className=" ">
                    ...
                    <div className="flex justify-between rounded-md px-8 items-center text-center bg-[#F5F5F3]">
                      ...
                      <div className="w-56 ">Tên sản phẩm</div>
                      <div className="w-56 ">Màu</div>
                      <div className="w-56 ">Kích cỡ</div>
                      <div className="w-56 ">Số lượng</div>
                      <div className="w-56 ">Giá</div>
                    </div>
