            ...
            <div className=" rounded-md w-full border-b  px-8 items-center ">
              <Menu>
                ...
                <div className="w-fit">
                  ...
                  >
                    <MenuItem className="w-4/5 bg-white">
                      <div className=" ">
                        <>
                          <div className="flex w-4/5 rounded-md justify-between items-center text-center bg-[#F5F5F3]">
                          ...
                          {item.order_details?.map((item) => (
                            <div
                              id={item.id_order}
                              className="w-4/5 flex justify-between rounded-md items-center text-center border-b px- py-2	"
                            >
                              <img
