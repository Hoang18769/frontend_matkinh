      ...
      <div className="w-4/5 sm:w-full items-center lg:px-4 sm:px-0">
        ...
        <div className="">
          {history.toReversed().map((item) => (
            <div className="lg:px-8 rounded-md w-full border-b lg:px-8 sm:px-0 items-center ">
                <div className="w-full items-center flex justify-between">
                  <div className="w-full flex justify-between ">
                    <div
                      ...
                      className="w-full"
                    >
                      <div className="flex py-4 rounded-md text-base items-center justify-between text-center hover:underline underline-offset-[4px] ">
                        <div className="lg:w-52 border md:w-44 md:px-2 sm:w-20 lg:px-4 sm:px-0 py-2 ">{item.id_order}</div>
                        <div className="lg:w-52 border md:w-44 md:px-2 sm:w-20 lg:px-4 sm:px-0 py-2 ">{item.date_order}</div>
                        <div className="lg:w-52 border md:w-44 md:px-2 sm:w-20 lg:px-4 sm:px-0 py-2 ">
                          {parseInt(item.total_order)+parseInt(item.shippingfee)}
                        </div>
                     <div className="">
                     {status_order_List.map((items) =>
                          items.id === item.status_order ? (
                            <div className="border lg:w-52 flex justify-center">
                ...
                <div className="w-full ">
                  <div className="w-full bg-white">
                    ...
                    >
                      ...
                      <p className="w-1/2 font-medium appearance-none flex items-center justify-between w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 mx-4 px-2 mb-3">
                          Tên người nhận
