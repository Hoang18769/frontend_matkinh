                ...
                <div className="w-full ">
                  <div className="w-full bg-white">
                    ...
                    >
                      ...
                      <p className="w-2/5 font-medium appearance-none flex items-center w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 mx-4 px-2 mb-3">
                          Tên người nhận:
                        ...
                        <p className="w-3/10 font-medium appearance-none flex items-center w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 mx-4 px-2 mb-3">
                          Số điện thoại
                          <span className="font-bold px-2 tracking-wide font-titleFont">
                            {item.phone_order}
                          </span>
                        </p>
                      </div>
                        
                        <p className="w-3/10 font-medium appearance-none flex items-center justify-between w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3">
                          Địa chỉ
