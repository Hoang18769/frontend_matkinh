                  ...
                  <div className="w-full bg-white">
                    ...
                    >
                      ...
                      <p className="w-4/10 font-medium appearance-none flex items-center w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-2 mb-3">
                        ...
                        <p className="w-3/10 font-medium appearance-none flex items-center w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 mx-4 px-3 mb-3">
                          Số điện thoại
