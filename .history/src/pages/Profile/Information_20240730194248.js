      ...
      return(
        <div className="w-full flex px-8 py-8 gap-5">
            ...
            <div className="w-4/5 text-lg ">
                ...
                <label>Địa chỉ: </label> <input className="font-mono text-xl px-8 tracking-wide" value={customer.address_customer}/><br/>
                <label>Ngày tạo tài khoản: </label> <input className="font-mono text-xl px-8 tracking-wide" value={customer.created_at}/><br/>
