  ...
  return (
    <div className="w-full lg:flex sm:flex-row px-8 sm:px-0 py-8 lg:gap-5 sm:gap-0 ">
      ...
      <div className="w-4/5 sm:w-full items-center lg:px-4 sm:px-0">
        <div className="w-full flex lg:px-8 sm:px-0 py-4 font-bold text-lg bg-[#F5F5F3] rounded-md">
          {list.map((item) => (
            <label className="lg:w-52 sm:w-20 py-4  text-center">{item}</label>
          ))}
          <label className="invisible  lg:w-52 sm:w-20 py-4 ">hidden</label>
        </div>
        <div className=" ">
          {history.toReversed().map((item) => (
            <div className=" rounded-md w-full border-b  lg:px-8 sm: items-center ">
              <div>
