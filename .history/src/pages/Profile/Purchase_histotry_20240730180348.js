              ...
              <>
                ...
                {item.order_details?.map((item)=>(
                  ...
                  productShop.find((items)=>(
                    ...
                    items.id_product.id===item.id_product?.id_product? <>
                    <img className="w-30 h-30" src={item.avt_product} alt="productImage" />                  
                   </>:null
                  ))
                ...
                {/* {productShop.map((item)=>{
                 ...
                 {/* <div>
                     {subItem.id_product} {subItem.id_product_variants} {subItem.quantity}
                  </div> */}
                </div>
                </>
