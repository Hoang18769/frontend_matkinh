                ...
                <div className="w-fit">
                  ...
                  >
                    <MenuItem className="block bg-white">
                      <div className=" ">
                        <>
                          <div className="flex rounded-md px-8 items-center text-center bg-[#F5F5F3]">
                          ...
                          {item.order_details?.map((item) => (
                            ...
                            >
                              ...
                              <div className="px-2 w-52">{item.quantity}</div>
                              <div className="px-2 w-52">{item.totalprice}</div>
                            </div>
                          ))}
                        </>
                      </div>
