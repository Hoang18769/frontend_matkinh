              ...
              <div>
                <div className=" items-center flex justify-between">
                  ...
                  item.order_details.length === item.feedback.length ? (
                    <p class=" lg:w-48 py-3 text-center  text-sm font-semibold rounded-lg bg-yellow-100 text-yellow-600">
                      Bạn đã đánh giá rồi
                    </p>
                  ) : item.status_order === 4 &&
                    item.order_details.length !== item.feedback.length ? (
                    <>
                      <div class="px-4 sm:px-0 py-3 whitespace-no-wrap text-right text-sm ">
                        <button
                          ...
                          class="h-10 lg:-28 border-indigo-500 border text-indigo-500 rounded-md transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none"
                        >
                          Đánh giá
                        </button>
                      </div>
