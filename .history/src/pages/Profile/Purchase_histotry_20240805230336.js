        ...
        <div className=" ">
          {history.map((item) => (
            <div className=" rounded-md w-full border-b  px-8 items-center ">
              <div>
               <a href="#{item.order_details.id_order}">
                      ...
                      <div className=" ">
                        <>
                          ...
                          {item.order_details?.map((item) => (
                            <div
                              id={item.id_order}
                              className="href=#{item.order_details.id_order} w-full flex justify-between rounded-md items-center text-center border-b px- py-2	"
                            >
                              <img
