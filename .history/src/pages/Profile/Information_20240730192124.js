      ...
      return(
        <div className="w-full flex px-8 py-8 gap-5">
            ...
            <div className="w-4/5 border text-lg ">
                <div className=""> Tên khách hàng: <span className="font-mono text-xl px-8 tracking-wide">{customer.name_customer}</span> </div>
                <div>Số điện thoại: {customer.phone_customer}</div>
