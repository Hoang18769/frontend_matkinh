...
{history.map((item) => (
          <div className=" rounded-md " >
            <Menu>
                ...
                <div className="w-56 px- py-2 border">{item.id_order}</div>
                <div className="w-56 px- py-2 border">{item.date_order}</div>
                <div className="w-56 px- py-2 border">{item.total_order}</div>
                {
                  status_order_List.map((items)=>(
                    (items.id===item.status_order?<>
                      <div className="w-56 px- py-2 border">{items.desc} </div>
                    </>:null)
                  ))
                }
                <div>
              ...
              <MenuItems anchor="bottom" className="z-10  w-[80%] px flex-1 w-4/5 mr-20 ">
