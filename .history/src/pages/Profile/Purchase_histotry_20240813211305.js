                ...
                <div className="w-full ">
                  <div className="w-full bg-white">
                    ...
                    >
                      ...
                      <p className="w-4/10 font-medium appearance-none flex items-center w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-2 mb-2">
                          Tên người nhận:
                          <span className=" px-2 font-semibold tracking-wide font-titleFont">
                            {item.name_order}
                          </span>
                        </p>
                        <p className="w-3/10 font-medium appearance-none flex items-center w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 mx-4 px-2 mb-2">
                          Số điện thoại
                          <span className="font-bold px-4 tracking-wide font-titleFont">
                            {item.phone_order}
                          </span>
                        </p>
                        <p className="w-3/10 font-medium appearance-none flex items-center w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-2">
                          Phí giao hàng
                          <span className="font-bold px-4 tracking-wide font-titleFont">
                            {item.shippingfee}
                          </span>
                        ...
                        <p className=" font-medium appearance-none flex items-center w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-6 mb-3">
                          Địa chỉ
