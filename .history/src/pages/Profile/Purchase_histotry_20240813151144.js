              ...
              <div>
                <div className=" items-center flex justify-between">
                  ...
                  <div class="px-4 py-3  whitespace-no-wrap text-right text-sm ">
                        ...
                        disabled=
                          onClick={() => handleFeedback(item)}
                          class="disable:opacity-50 h-10 w-28 border-indigo-500 border text-indigo-500 rounded-md transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none"
                        >
                          Đánh giá
                        </button>
                      </div>}
