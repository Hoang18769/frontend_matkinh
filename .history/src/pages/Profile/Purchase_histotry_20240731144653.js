        ...
        {history.map((item) => (
          <>
            <div className="flex px-8 py-4 border justify-between">
              <div className=" px-2 py-2">{item.id_order}</div>
              <div className=" px-2 py-2">{item.date_order}</div>
              <div className=" px-2 py-2">{item.total_order}</div>
              <div className=" px-2 py-2">{item.status_order} </div>
