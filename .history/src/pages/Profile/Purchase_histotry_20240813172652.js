                  ...
                  <div className="w-full bg-white">
                    ...
                    >
                      ...
                      <div className="bg-white shadow-md rounded px-4 pt-4 pb-8 mb-4 my-2 ">
                        ...
                        <p className="wfont-medium appearance-none flex items-center justify-between w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3">
                          Số điện thoại
