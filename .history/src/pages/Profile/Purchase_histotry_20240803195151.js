                      ...
                      <div className=" ">
                        <>
                          <div className="flex rounded-md  items-center text-center bg-[#F5F5F3]">
                            ...
                            <div className="w-4 ">Tên sản phẩm</div>
                            <div className="w-4 ">Màu</div>
                            <div className="w-4 ">Kích cỡ</div>
                            <div className="w-4 ">Số lượng</div>
                            <div className="w-4 ">Giá</div>
                          </div>
                          ...
                          {item.order_details?.map((item) => (
                            ...
                            >
                              ...
                              <div className="px-2 w-4">{item.quantity}</div>
                              <div className="px-2 w-4">{item.totalprice}</div>
                            </div>
                          ))}
                        </>
                      </div>
