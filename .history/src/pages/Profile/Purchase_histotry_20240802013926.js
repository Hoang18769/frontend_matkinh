        ...
        {history.map((item) => (
          <div className=" rounded-md" >
            <Menu>
                  ...
                  <div className="flex px-8 py-4 border-b rounded-md justify-between">
                <div className="w-5 px-4 py-2">{item.id_order}</div>
                <div className="w-5 px-4 py-2">{item.date_order}</div>
                <div className="w-5 px-4 py-2">{item.total_order}</div>
                {
                  status_order_List.map((items)=>(
                    (items.id===item.status_order?<>
                      <div className="w-5 px-4 py-2">{items.desc} </div>
                    </>:null)
                  ))
                }
                <div>
