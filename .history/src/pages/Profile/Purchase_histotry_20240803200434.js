                      ...
                      <div className=" ">
                        <>
                          <div className="flex rounded-md  items-center text-center bg-[#F5F5F3]">
                            ...
                            <div className="w-44 ">Tên sản phẩm</div>
                            <div className="w-44 ">Màu</div>
                            <div className="w-44 ">Kích cỡ</div>
                            <div className="w-44 ">Số lượng</div>
                            <div className="w-44 ">Giá</div>
                          </div>
                          ...
                          {item.order_details?.map((item) => (
                            ...
                            >
                              ...
                              <div className="px-2 w-44">{item.quantity}</div>
                              <div className="px-2 w-44">{item.totalprice}</div>
                            </div>
                          ))}
                        </>
                      </div>
