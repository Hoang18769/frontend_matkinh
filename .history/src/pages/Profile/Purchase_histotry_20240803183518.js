                ...
                <div className="w-full items-center flex justify-between">
                  <MenuButton className="border w-fit ">
                    <div className="flex py-4 rounded-md justify-between items-center text-center hover:underline underline-offset-[4px] ">
                      <div className="w-52 px-8 py-2 border">{item.id_order}</div>
                      <div className="w-52 px-8 py-2 border">{item.date_order}</div>
                      <div className="w-52 px-8 py-2 border">{item.total_order}</div>
