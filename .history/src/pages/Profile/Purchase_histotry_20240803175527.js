...
{history.map((item) => (
          <div className=" rounded-md  border-b  px-8 items-center " >
            ...
            <MenuButton className="" >
                ...
                <div className="w-48 px-4 py-2 ">{item.id_order}</div>
                <div className="w-48 px-4 py-2 ">{item.date_order}</div>
                <div className="w-48 px-4 py-2 ">{item.total_order}</div>
                {
                ...
                {item.status_order===4?<>
                  <div onClick={handleDetail(item)} className="w-52 hover:bg-[#F5F5F3]">Đánh giá</div>
                </>:
