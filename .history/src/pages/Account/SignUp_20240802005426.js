...
const SignUp = () => {
  ...
  const handleSignUp = (e) => {
    ...
    if (checked) {
      ...
      }else if (phone_customer.length !== 10) {
        setErrPhone("Số điện thoại phải 10 số");
      }
      if (!password_account) {
      ...
      if (!email_customer) {
        setErremail_accountCus("Vui lòng nhập email khách hảng");
      } else {
        if (!email_accountValidation(email_customer)) {
          setErremail_accountCus("Vui lòng nhập email khách hảng đã xác thực");
        }
      }
      if (
        name_account &&
        ...
        axios.post("https://matkinhcaolo.io.vn/api/register", {
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-start mdl:items-center gap-2">
                  ...
                  <p className="text-sm text-primeColor">
                    Bạn đồng ý với chính sách của Mắt Kính Cao Lỗ{" "}
