...
const SignUp = () => {
  ...
  const handleemail_account = (e) => {
    setemail_account(e.target.value);
    setErremail_account("");
  };
  const handlePhone = (e) => {
  ...
  const handleSignUp = (e) => {
    ...
    if (checked) {
      ...
      if (!email_account) {
        setErremail_account("Vui lòng nhập email tài khoản");
      } else {
        if (!email_accountValidation(email_account)) {
          setErremail_account("Vui lòng nhập email tài khoản đã xác thuc");
        }
      }
      if (!phone_customer) {
      ...
      if (!email_customer) {
        setErremail_accountCus("Vui lòng nhập email khách hàng");
      }
      ...
      if (
        name_account &&
        email_account &&
        email_accountValidation(email_account) &&
        password_account &&
            ...
            <div className="px-6 py-4 w-full h-[96%] flex flex-col justify-start overflow-y-scroll scrollbar-thin scrollbar-thumb-primeColor">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-.5">
                  ...
                  <input
                    onChange={handleemail_accountCus}
