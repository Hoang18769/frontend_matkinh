...
const ProductDetails = () => {
  ...
  return (
    ...
    >
      ...
      <Rating name="read-only" value={Math.round(feedback.reduce((a,b)=>a+b.rating,0))} readOnly />
    </Box>
          ...
          <h3 className="text-gray-600 text-2xl " onClick={()=>{setShow(!show)}}>Đánh giá sản phẩm </h3> 
          <IoMdArrowDropdown  />
          </div>
          ...
          <div className="w-full flex justify-start items-start flex-col p-8 ">
            <div id="menu" className="md:block ">
              ...
              <div className=" w-full flex justify-between items-center flex-row space-x-2.5 ">
                ...
                <p className="mx-4">Phân loại: {item.desc_color} {item.desc_size} </p>
                <Box
      sx={{
        '& > legend': { mt: 2 },
      }}
