  ...
  return (
    <div className="container mx-auto px-8">
      <div className="flex justify-between lg:flex-row gap-16 lg:items-center">
        <div className=" md:w-full flex self-start justify-start w-2/5">
          <img
        ...
        <div className="md:w-full flex flex-col gap-4 lg:w-2/4">
          ...
          {feedback?.map((item) => (
            <div
              className=" md:w-full md:px-2 2xl:px-0 2xl:container 2xl:mx-auto  flex justify-center items-center"
