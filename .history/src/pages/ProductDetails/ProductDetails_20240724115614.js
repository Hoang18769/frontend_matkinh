  ...
  return (
    ...
    <div className="flex flex-col justify-between lg:flex-row gap-16 lg:items-center">
      ...
      <p className="text-[#767676] text-[14px]">
        ...
        <h6 className="text-2xl mr-5  font-semibold line-through">
          {productDetail.price_product} VND
        </h6>
          {/* <p class="mr-2 text-lg font-semibold ">$20.00</p> */}
      <p class="text-base  font-medium text-gray-500 line-through dark:text-gray-400">{productDetail.price_product} VNSD</p>
        </div>
