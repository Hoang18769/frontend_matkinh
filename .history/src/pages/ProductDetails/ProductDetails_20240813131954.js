...
const ProductDetails = () => {
  ...
  return (
    <div className="container mx-auto px-8">
      <div className="flex justify-between lg:flex-col gap-16 lg:items-center">
        ...
        <div className="md:w-full flex flex-col gap-4 lg:w-2/4">
          ...
          {feedback?.map((item) => (
            <div
              className=" md:w-full md:px-6 2xl:px-0 2xl:container 2xl:mx-auto  flex justify-center items-center"
