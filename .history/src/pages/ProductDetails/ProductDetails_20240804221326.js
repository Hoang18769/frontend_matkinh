  ...
  return (
    <div className="container mx-auto px-8">
      <div className="flex flex-col justify-between lg:flex-row gap-16 lg:items-center">
        ...
        {feedback?.map((item)=>(
          <div className="px-4 md:px-6 2xl:px-0 2xl:container 2xl:mx-auto border flex justify-center items-center">
        <div className="flex flex-col justify-start items-start w-full border ">
          <div className="w-full flex justify-start items-start flex-col p-8 border">
            <div id="menu" className="md:block border">
              ...
              <div className="mt-6 flex justify-start items-center flex-row space-x-2.5 border">
              
                <div className="flex flex-col justify-start items-start space-y-2">
                  <p className="text-base font-medium leading-none">
                    Nguyễn Thị Anh
                  </p>
                  <p className="text-sm leading-none">{item.updated_at}</p>
                </div>
              </div>
            </div>

            <div className="w-full flex justify-start items-start flex-col md:px-8 py-8">
              <div className="flex flex-col md:flex-row flex justify-between w-full">
             
              <p>Phân loại: {productDetail.variants?.map((sub)=>(
                sub.id_product_variants===item.id_product_variants?
                <>
                  <p>{sub.size?.desc_size}</p>
                </>:
                null
              ))} </p>
              </div>
