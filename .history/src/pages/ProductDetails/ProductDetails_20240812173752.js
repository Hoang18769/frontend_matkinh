    ...
    <div  className="container mx-auto px-8">
      <div className="flex  justify-between lg:flex-row gap-16 lg:items-center">
        ...
        <div className="flex flex-col gap-4 lg:w-2/4">
                ...
                <select
                  ...
                  onChange={(e) => {
                    setId_variant(e.target.value);
                      ...
                      let i=productDetail.variants?.find((item)=>(
                        parseInt(item.id_product_variants)===parseInt(e.target.value)
                      ))
          ...
          <div id="addToCart" className="flex flex-row items-center gap-12">
            <button
              onClick={() => {
                if (id_variant === 0) {
                  swal(
              ...
              className="bg-indigo-500 text-white font-semibold py-3 px-16 rounded-xl h-full"
            >
              Thêm vào giỏ hàng
            </button>
          </div>
