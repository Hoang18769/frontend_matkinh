    ...
    <div className="container mx-auto px-8">
      <div className="flex justify-between lg:flex-row sm:flex-col lg:items-center">
        ...
        <div className="md:w-full flex flex-col gap-4 lg:w-2/4">
          ...
          {feedback?.map((item) => (
            <div
              className="border md:w-full  2xl:px-0 2xl:container 2xl:mx-auto  flex justify-center items-center"
              style={{ display: show ? "flex" : "none" }}
            >
              <div className="flex flex-col justify-start items-start w-full  ">
                <div className="w-full flex justify-between items-start flex-col  ">
                  <div id="menu" className="md:block ">
                    <div className=" w-full  justify-between items-center flex-row space-x-2.5 ">
                  ...
                  <div className="w-full flex justify-start items-start flex-col py-4 md:px-8 ">
