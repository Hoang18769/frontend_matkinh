...
const ProductDetails = () => {
  ...
  useEffect(() => {
    fetchData();
    // productDetail.variants?.find((item)=>(
        ...
        <div className="flex flex-col gap-4 lg:w-2/4">
              ...
              <div className="relative">
                <select
                  ...
                  onChange={(e) => {
                    ...
                    let item = productDetail.variants?.map((item) =>
                      console.log(item)
                    );
                    // // setQuantity(item.variants.quantity);
          ...
          <div className="flex flex-row items-center gap-12">
            <button
              onClick={() => {
                if(id_variant===0){
                  swal("Thất bại", result.data.message, "success");

                }
                else{
                  let item = productDetail.variants.find(
                  (item) =>
