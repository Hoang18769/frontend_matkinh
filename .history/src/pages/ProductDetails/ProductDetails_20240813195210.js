...
const ProductDetails = () => {
  ...
  useEffect(()=>{
    console.log(productDetail.total_stock)
    // if ( productDetail.total_stock===0) {
  ...
  return (
    <div className="container mx-auto px-8">
      <div className="flex justify-between lg:flex-row sm:flex-col lg:items-center">
        <div className=" lg:w-2/5 sm:w-full px-2 flex self-start justify-start">
          <img
        ...
        <div className="md:w-full flex flex-col gap-4 lg:w-2/4">
          ...
          <div className="flex flex-row items-center gap-12">
            <button
              id="addToCart"
                 disabled={productDetail.total_stock===0?"true":"false"}
              onClick={() => {
                if (id_variant === 0) {
                  swal(
                    "Thất bại",
              ...
              className="disabled:opacity-50 bg-indigo-500 text-white font-semibold py-3 px-16 rounded-xl h-full disabled:opacity-50"
            >
              Thêm vào giỏ hàng
            </button>
          </div>
          ...
          {feedback?.map((item) => (
            <div
              className="shadow-lg md:w-full 2xl:px-0 2xl:container 2xl:mx-auto  flex justify-center items-center"
            ...
            >
              <div className="flex flex-col justify-start items-start w-full  ">
                <div className="w-full flex justify-between  flex-col  ">
                  <div id="menu" className="md:block ">
                    <div className=" w-full flex justify-between items-center flex-row space-x-2.5 ">
                      <div className="flex  items-start ">
                        <p className="text-base px-2 text-2xl font-medium leading-none">
                          {item.customer}
                        </p>
                  ...
                  <div className="w-full flex justify-start items-start flex-col pb-4 md:px-8 ">
                    <div id="menu2" className=" md:block">
                      <p className="mt-3 text-base leading-normal w-full ">
                        {item.comment}
                      </p>
                    </div>
                  </div>
